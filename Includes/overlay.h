...
void gui::setup(LPDIRECT3DDEVICE9 device, HWND window)
{
	...
	FN = io.Fonts->AddFontFromMemoryTTF(rawData1, sizeof(rawData1), 20.0f, &font_config, ranges);	// u gotta download this font and put it in ur c drive as im not downloadin it from bytes
